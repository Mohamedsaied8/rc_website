    ...
    <div class="mx-auto max-w-7xl px-6 py-16">
        <div class="grid grid-cols-1 gap-12 md:grid-cols-2 lg:grid-cols-4">
            ...
            <div>
                ...
                <ul class="space-y-4">
                    ...
                    <li><a href="#" class="text-sm text-slate-600 transition-colors hover:text-cyan-600">{{ cms('global.footer.services_4', 'Consulting') }}</a></li>
                </ul>
            </div>
            ...
            <div>
                ...
                <ul class="space-y-4">
                    ...
                    <li><a href="#" class="text-sm text-slate-600 transition-colors hover:text-cyan-600">{{ cms('global.footer.company_4', 'Contact') }}</a></li>
                </ul>
            </div>
            ...
            <div>
                ...
                <ul class="space-y-4">
                    ...
                    <li><a href="#" class="text-sm text-slate-600 transition-colors hover:text-cyan-600">{{ cms('global.footer.tech_4', 'ROS/ROS2') }}</a></li>
                    <li><a href="#" class="text-sm text-slate-600 transition-colors hover:text-cyan-600">{{ cms('global.footer.tech_5', 'Embedded Linux') }}</a></li>
                </ul>
            </div>
        </div>
        ...
        <div class="mt-16 flex flex-col items-center justify-between gap-6 border-t border-slate-200 pt-8 sm:flex-row">
            ...
            <div class="flex items-center gap-4">
                <a href="{{ cms('global.footer.linkedin_url', '#', true) }}" aria-label="LinkedIn" class="flex h-10 w-10 items-center justify-center rounded-lg bg-slate-100 text-slate-500 transition-all hover:bg-cyan-50 hover:text-cyan-600">
                    <svg width="20" height="20" fill="currentColor" viewBox="0 0 24 24">
                        <path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z" />
                    </svg>
                </a>
                <a href="{{ cms('global.footer.github_url', '#', true) }}" aria-label="GitHub" class="flex h-10 w-10 items-center justify-center rounded-lg bg-slate-100 text-slate-500 transition-all hover:bg-cyan-50 hover:text-cyan-600">
                    <svg width="20" height="20" fill="currentColor" viewBox="0 0 24 24">
                ...
                <a href="#" aria-label="Twitter" class="flex h-10 w-10 items-center justify-center rounded-lg bg-slate-100 text-slate-500 transition-all hover:bg-cyan-50 hover:text-cyan-600">
                    <svg width="20" height="20" fill="currentColor" viewBox="0 0 24 24">
