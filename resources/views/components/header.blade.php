...
>
    ...
    <nav class="max-w-7xl mx-auto px-6 lg:px-8">
        <div class="flex items-center justify-between h-18 py-4">
            ...
            <div class="hidden md:flex items-center gap-1">
                ...
                <a href="{{ route('blog.index') }}" class="relative px-4 py-2 text-sm text-slate-400 hover:text-white transition-colors duration-300 rounded-lg hover:bg-white/[0.04]">
                    Blog
                </a>
    ...
    >
        <div class="px-6 pb-6 pt-2 space-y-1 border-t border-white/[0.06] bg-[#0A0A0A]/95 backdrop-blur-2xl">
            ...
            <a href="{{ route('blog.index') }}" @click="mobileOpen = false" class="block px-4 py-3 text-sm text-slate-400 hover:text-white hover:bg-white/[0.04] rounded-lg transition-colors">Blog</a>
