...
@section('content')
    ...
    <section class="relative min-h-screen flex items-center overflow-hidden pt-24 pb-12">
        ...
        <div class="relative z-10 max-w-7xl mx-auto px-6 lg:px-8 w-full text-center">
            ...
            <!-- Headline -->
            <h1 class="text-5xl md:text-6xl lg:text-7xl font-extrabold text-slate-900 tracking-tight leading-[1.1] mb-6 animate-fade-in-up" style="animation-delay: 200ms;">
                ...
                <div class="flex flex-col sm:flex-row items-center gap-6 relative z-20">
                    ...
                    <div class="relative" @mouseenter="activeHub = 'products'" @mouseleave="activeHub = null">
                        ...
                        <div x-show="activeHub === 'products'" 
                             ...
                             class="absolute left-1/2 -translate-x-1/2 top-full mt-12 flex flex-wrap justify-center gap-4 w-[800px] z-10 pointer-events-auto"
                             style="display: none;">
                            
                            <!-- SVG Wires for Products -->
                            <svg class="absolute bottom-full left-0 w-full h-[48px] -z-10" viewBox="0 0 800 48" preserveAspectRatio="none">
                    ...
                    <div class="relative" @mouseenter="activeHub = 'services'" @mouseleave="activeHub = null">
                        ...
                        <div x-show="activeHub === 'services'" 
                             ...
                             x-transition:leave-start="opacity-100 translate-y-0"
                             x-transition:leave-end="opacity-0 translate-y-4"
                             class="absolute left-1/2 -translate-x-1/2 top-full mt-12 flex flex-wrap justify-center gap-3 w-[800px] z-10 pointer-events-auto"
                             style="display: none;">
    ...
    <!-- Services Overview -->
    <section class="relative py-24 overflow-hidden border-t border-slate-200 bg-white">
        <div class="relative z-10 max-w-7xl mx-auto px-6 lg:px-8">
            ...
            <div class="grid md:grid-cols-4 gap-6">
                <!-- R&D -->
                <div class="relative bg-white border border-slate-200 shadow-sm rounded-2xl p-6 hover:border-cyan-300 hover:shadow-lg hover:shadow-cyan-500/10 transition-all duration-300 group flex flex-col items-center text-center">
                    <div class="w-full h-32 relative rounded-xl overflow-hidden mb-6">
                        <img src="{{ cms('home.services.rnd_img', asset('images/rnd_service.png'), true) }}" data-cms-image="home.services.rnd_img" alt="R&D" class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500">
                    </div>
                    <h3 class="text-lg font-bold text-slate-900 mb-3">{{ cms('home.services.rnd_title', 'Research & Development') }}</h3>
                    <p class="text-slate-600 text-sm flex-grow mb-6">{{ cms('home.services.rnd_desc', 'Pioneering intelligent robotics solutions, from autonomous driving to advanced software platforms.') }}</p>
                    <a href="{{ route('services.show', 'rnd') }}" class="before:absolute before:inset-0 before:z-10 text-sm font-bold text-cyan-600 hover:text-cyan-500 group-hover:translate-x-1 transition-transform">{{ cms('home.services.rnd_link', 'Discover R&D &rarr;') }}</a>
                </div>

                <!-- Consultation -->
                <div class="relative bg-white border border-slate-200 shadow-sm rounded-2xl p-6 hover:border-blue-300 hover:shadow-lg hover:shadow-blue-500/10 transition-all duration-300 group flex flex-col items-center text-center">
                    <div class="w-full h-32 relative rounded-xl overflow-hidden mb-6">
                        <div class="absolute inset-0 bg-blue-900/10 z-10 group-hover:bg-transparent transition-colors"></div>
                        <img src="{{ cms('home.services.consultation_img', asset('images/consultation_service.png'), true) }}" data-cms-image="home.services.consultation_img" alt="Consultation" class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500">
                    </div>
                    <h3 class="text-lg font-bold text-slate-900 mb-3">{{ cms('home.services.consultation_title', 'Engineering Consultation') }}</h3>
                    <p class="text-slate-600 text-sm flex-grow mb-6">{{ cms('home.services.consultation_desc', 'Expert guidance on system architecture, embedded systems, and robotic deployments.') }}</p>
                    <a href="{{ route('services.index') }}" class="before:absolute before:inset-0 before:z-10 text-sm font-bold text-blue-600 hover:text-blue-500 group-hover:translate-x-1 transition-transform">{{ cms('home.services.consultation_link', 'Learn more &rarr;') }}</a>
                </div>

                <!-- Training -->
                <div class="relative bg-white border border-slate-200 shadow-sm rounded-2xl p-6 hover:border-emerald-300 hover:shadow-lg hover:shadow-emerald-500/10 transition-all duration-300 group flex flex-col items-center text-center">
                    <div class="w-full h-32 relative rounded-xl overflow-hidden mb-6">
                        <img src="{{ cms('home.services.training_img', asset('images/training_service.png'), true) }}" data-cms-image="home.services.training_img" alt="Training" class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500">
                    </div>
                    <h3 class="text-lg font-bold text-slate-900 mb-3">{{ cms('home.services.training_title', 'Professional Training') }}</h3>
                    <p class="text-slate-600 text-sm flex-grow mb-6">{{ cms('home.services.training_desc', 'Industry-leading educational programs bridging the gap between academia and real-world tech.') }}</p>
                    <a href="{{ route('programs.index') }}" class="before:absolute before:inset-0 before:z-10 text-sm font-bold text-emerald-600 hover:text-emerald-500 group-hover:translate-x-1 transition-transform">{{ cms('home.services.training_link', 'View programs &rarr;') }}</a>
                </div>

                <!-- Outsourcing -->
                <div class="relative bg-white border border-slate-200 shadow-sm rounded-2xl p-6 hover:border-purple-300 hover:shadow-lg hover:shadow-purple-500/10 transition-all duration-300 group flex flex-col items-center text-center">
                    <div class="w-full h-32 relative rounded-xl overflow-hidden mb-6">
                        <img src="{{ cms('home.services.outsourcing_img', asset('images/outsourcing_service.png'), true) }}" data-cms-image="home.services.outsourcing_img" alt="Outsourcing" class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500">
                    </div>
                    <h3 class="text-lg font-bold text-slate-900 mb-3">{{ cms('home.services.outsourcing_title', 'Outsourcing') }}</h3>
                    <p class="text-slate-600 text-sm flex-grow mb-6">{{ cms('home.services.outsourcing_desc', 'Dedicated teams of elite engineers ready to accelerate your project development cycle.') }}</p>
                    <a href="{{ route('services.index') }}" class="before:absolute before:inset-0 before:z-10 text-sm font-bold text-purple-600 hover:text-purple-500 group-hover:translate-x-1 transition-transform">{{ cms('home.services.outsourcing_link', 'Learn more &rarr;') }}</a>
                </div>
            </div>
        </div>
    </section>
    ...
    <!-- Flagship Products -->
    <section class="relative py-24 overflow-hidden border-t border-slate-200 bg-slate-50">
            ...
            <div class="grid md:grid-cols-3 gap-8">
                ...
                <div class="relative bg-white border border-slate-200 shadow-md rounded-3xl overflow-hidden group hover:border-cyan-300 transition-all duration-500">
                    ...
                    <div class="p-8 z-20">
                        ...
                        <a href="{{ route('products.index') }}" class="before:absolute before:inset-0 before:z-10 inline-flex items-center gap-2 px-5 py-2.5 bg-slate-100 hover:bg-cyan-50 border border-slate-200 hover:border-cyan-200 rounded-xl text-cyan-700 text-sm font-bold transition-colors">
                ...
                <div class="relative bg-white border border-slate-200 shadow-md rounded-3xl overflow-hidden group hover:border-emerald-300 transition-all duration-500">
                    ...
                    <div class="p-8 z-20">
                        ...
                        <a href="{{ route('products.index') }}" class="before:absolute before:inset-0 before:z-10 inline-flex items-center gap-2 px-5 py-2.5 bg-slate-100 hover:bg-emerald-50 border border-slate-200 hover:border-emerald-200 rounded-xl text-emerald-700 text-sm font-bold transition-colors">
                ...
                <div class="relative bg-white border border-slate-200 shadow-md rounded-3xl overflow-hidden group hover:border-purple-300 transition-all duration-500">
                    ...
                    <div class="p-8 z-20">
                        ...
                        <a href="{{ route('products.index') }}" class="before:absolute before:inset-0 before:z-10 inline-flex items-center gap-2 px-5 py-2.5 bg-slate-100 hover:bg-purple-50 border border-slate-200 hover:border-purple-200 rounded-xl text-purple-700 text-sm font-bold transition-colors">
    ...
    <section class="relative py-32 overflow-hidden border-t border-slate-200 bg-white">
        ...
        <div class="relative z-10 text-center">
            <h2 class="text-5xl md:text-6xl font-extrabold text-slate-900 tracking-tight mb-8">
            ...
            <a href="{{ route('contact') }}" class="inline-flex items-center gap-2 px-8 py-4 bg-gradient-to-r from-cyan-500 to-emerald-500 text-white text-lg font-bold rounded-xl shadow-lg shadow-cyan-500/30 hover:shadow-cyan-500/50 transition-all duration-300 hover:-translate-y-1">
