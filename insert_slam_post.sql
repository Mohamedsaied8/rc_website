-- SLAM Tutorial Blog Post
-- Insert this into your blog_posts table

INSERT INTO blog_posts (title, slug, content, excerpt, cover_image, status, created_at, updated_at)
VALUES (
    'SLAM Tutorial: Simultaneous Localization and Mapping for Robotics',
    'slam-tutorial-simultaneous-localization-and-mapping',
    '<h2>What is SLAM?</h2>
...
<p>Start experimenting with the ROS2 examples above, and you''ll be building maps and navigating autonomously in no time!</p>',
    'Learn about SLAM (Simultaneous Localization and Mapping) - what it is, why it''s crucial for robotics, the most common algorithms, and how to implement it in ROS2 with practical examples.',
